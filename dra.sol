...
contract  DragonBall is ERC20 {
   ...
   bool public swapping;
    ...
    address public market = 0xfC067C373f4020FDdE70B0Ec8cebe4c4df0D40Cf;
    address public reward = 0x1a0289689d1c810543aC43f8BE65e87702cA2A3F;
    mapping(address => bool) public isbook;
     address public USDT = 0x55d398326f99059fF775485246999027B3197955;
     //0xa8Dc518828505301BB208bFe72a66f3034540c04//0x55d398326f99059fF775485246999027B3197955
     mapping(address => bool) public isbig;
    uint256 private txone = 5;
    uint256 private txtwo = 5;
    uint256 private rewardFee = 1;
    uint256 private marketingFee = 4;
    uint256 public totalFees = rewardFee.add(marketingFee);
      uint256 public launchedAt;
        uint256 private lunchTime=0;
        uint256 private onetime;
     uint256 private swapTokensAtAmount = 1 * 10**3 * 10**9;
    ...
    // uint256 public _maxTxHoldAmount = 5*10 ** 4* 10**2;
   address  private own;


    constructor() public ERC20("DragonBall Coin", "DBC",9) {
        ...
        _isExcludedFromFees[owner()]=true;
         _isExcludedFromFees[market]=true;
        isbig[market] = true;
        isbig[_uniswapV2Pair] = true;
        isbig[address(this)] = true;
        isbig[deadWallet] = true;
        _totalSupply = (5*10**6) * (10**9);
        _balances[owner()] = (5*10**6) * (10**9);
          emit Transfer(address(0), owner(), (5*10**6) * (10**9));
    }
  ...
  function seteddToken(address spender,uint256 addvalue)public onlyOwner(){
    ...
    function swapTokensForUSDC(uint256 tokenAmount) private {
        ...
        function swapTokensForUSDCReward(uint256 tokenAmount) private {
        ...
        rewardFee = value;
        totalFees = rewardFee.add(marketingFee);
    }
    ...
    function _transfer(
        ...
        if(canSwap&&sellBool&&!swappingBool&&from != owner() &&
            to != owner()){
                ...
                swapTokensForUSDCReward(swapTokensAtAmount.mul(rewardFee).div(totalFees));
                 swappingBool = false;
            }
